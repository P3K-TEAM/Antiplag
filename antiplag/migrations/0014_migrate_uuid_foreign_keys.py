    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.CASCADE, null=True, related_name="documents", to="antiplag.Submission"
            )
        ),
        migrations.AddField(
            model_name="Result",
            ...
            field=models.OneToOneField(
                on_delete=models.CASCADE, null=True, related_name="result", to="antiplag.Document"
            )
        ),
